...
export const resources = {
  en: {
    translation: {
      ...
      'duration': 'Duration',
      'platform': 'Platform',
      'madeWithLove': 'Made with ♥️ for the people',
  ...
  es: {
    translation: {
      ...
      'duration': 'Duración',
      'platform': 'Plataforma',
      'madeWithLove': 'Hecho con ♥️ para el pueblo',
  ...
  it: {
    translation: {
      ...
      'madeWithLove': 'Fatto con ♥️ per il popolo',
  ...
  pt: {
    translation: {
      ...
      'duration': 'Duração',
      'platform': 'Plataforma',
      'madeWithLove': 'Feito com ♥️ para o povo',
